...
class FileDescriptorSet private constructor(
    ...
    class FileDescriptorSetDsl {
        ...
        fun build(): FileDescriptorSet = FileDescriptorSet(
            finishList(file),
            unknownFields
        )
    }
    ...
    companion object Deserializer :
        KtDeserializer<FileDescriptorSet>,
...
class FileDescriptorProto private constructor(
    ...
    class FileDescriptorProtoDsl {
        ...
        fun build(): FileDescriptorProto = FileDescriptorProto(
            name,
            `package`,
    ...
    companion object Deserializer :
        KtDeserializer<FileDescriptorProto>,
...
class DescriptorProto private constructor(
    ...
    class DescriptorProtoDsl {
        ...
        fun build(): DescriptorProto = DescriptorProto(
            name,
            finishList(field),
    ...
    companion object Deserializer :
        KtDeserializer<DescriptorProto>,
    ...
    class ExtensionRange private constructor(
        ...
        class ExtensionRangeDsl {
            ...
            fun build(): ExtensionRange = ExtensionRange(
                start,
                end,
                options,
                unknownFields
    ...
    class ReservedRange private constructor(
        ...
        class ReservedRangeDsl {
            ...
            fun build(): ReservedRange = ReservedRange(
                start,
                end,
                unknownFields
            )
...
class ExtensionRangeOptions private constructor(
    ...
    companion object Deserializer :
        KtDeserializer<ExtensionRangeOptions>,
        ...
        override fun deserialize(deserializer: KtMessageDeserializer):
            ...
            while (true) {
                when (deserializer.readTag()) {
                    0 -> return ExtensionRangeOptions(
                        finishList(uninterpretedOption),
                        UnknownFieldSet.from(unknownFields)
                    )
...
class FieldDescriptorProto private constructor(
    ...
    class FieldDescriptorProtoDsl {
        ...
        fun build(): FieldDescriptorProto = FieldDescriptorProto(
            name,
            extendee,
            number,
            label,
    ...
    companion object Deserializer :
        KtDeserializer<FieldDescriptorProto>,
...
class OneofDescriptorProto private constructor(
    ...
    class OneofDescriptorProtoDsl {
        ...
        fun build(): OneofDescriptorProto = OneofDescriptorProto(
            name,
            options,
            unknownFields
        )
    ...
    companion object Deserializer :
        KtDeserializer<OneofDescriptorProto>,
...
class EnumDescriptorProto private constructor(
    ...
    class EnumDescriptorProtoDsl {
        ...
        fun build(): EnumDescriptorProto = EnumDescriptorProto(
            name,
            finishList(value),
            options,
            finishList(reservedRange),
    ...
    companion object Deserializer :
        KtDeserializer<EnumDescriptorProto>,
    ...
    class EnumReservedRange private constructor(
        ...
        class EnumReservedRangeDsl {
            ...
            fun build(): EnumReservedRange = EnumReservedRange(
                start,
                end,
                unknownFields
            )
        ...
        companion object Deserializer :
            KtDeserializer<EnumReservedRange>,
...
class EnumValueDescriptorProto private constructor(
    ...
    class EnumValueDescriptorProtoDsl {
        ...
        fun build(): EnumValueDescriptorProto = EnumValueDescriptorProto(
            name,
            number,
            options,
            unknownFields
    ...
    companion object Deserializer :
        KtDeserializer<EnumValueDescriptorProto>,
        ...
        override fun deserialize(deserializer: KtMessageDeserializer):
            ...
            while (true) {
                when (deserializer.readTag()) {
                    0 -> return EnumValueDescriptorProto(
                        name,
                        number,
                        options,
                        UnknownFieldSet.from(unknownFields)
...
class ServiceDescriptorProto private constructor(
    ...
    class ServiceDescriptorProtoDsl {
        ...
        fun build(): ServiceDescriptorProto = ServiceDescriptorProto(
            name,
            finishList(method),
            options,
            unknownFields
    ...
    companion object Deserializer :
        KtDeserializer<ServiceDescriptorProto>,
        ...
        override fun deserialize(deserializer: KtMessageDeserializer):
            ...
            while (true) {
                when (deserializer.readTag()) {
                    0 -> return ServiceDescriptorProto(
                        name,
                        finishList(method),
                        options,
                        UnknownFieldSet.from(unknownFields)
...
class MethodDescriptorProto private constructor(
    ...
    class MethodDescriptorProtoDsl {
        ...
        fun build(): MethodDescriptorProto = MethodDescriptorProto(
            name,
            inputType,
            outputType,
            options,
    ...
    companion object Deserializer :
        KtDeserializer<MethodDescriptorProto>,
        ...
        override fun deserialize(deserializer: KtMessageDeserializer):
            ...
            while (true) {
                when (deserializer.readTag()) {
                    0 -> return MethodDescriptorProto(
                        name,
                        inputType,
                        outputType,
                        options,
...
class FileOptions private constructor(
    ...
    class FileOptionsDsl {
        ...
        fun build(): FileOptions = FileOptions(
            javaPackage,
            javaOuterClassname,
            optimizeFor,
            javaMultipleFiles,
...
class MessageOptions private constructor(
    ...
    class MessageOptionsDsl {
        ...
        fun build(): MessageOptions = MessageOptions(
...
class FieldOptions private constructor(
    ...
    class FieldOptionsDsl {
        ...
        fun build(): FieldOptions = FieldOptions(
            ctype,
            packed,
            deprecated,
            lazy,
...
class OneofOptions private constructor(
    ...
    class OneofOptionsDsl {
        ...
        fun build(): OneofOptions = OneofOptions(
            finishList(uninterpretedOption),
            unknownFields
        )
    }
...
class EnumOptions private constructor(
    ...
    class EnumOptionsDsl {
        ...
        fun build(): EnumOptions = EnumOptions(
            allowAlias,
            deprecated,
            finishList(uninterpretedOption),
            unknownFields
...
class EnumValueOptions private constructor(
    ...
    class EnumValueOptionsDsl {
        ...
        fun build(): EnumValueOptions = EnumValueOptions(
            deprecated,
            finishList(uninterpretedOption),
            unknownFields
        )
    ...
    companion object Deserializer :
        KtDeserializer<EnumValueOptions>,
...
class ServiceOptions private constructor(
    ...
    class ServiceOptionsDsl {
        ...
        fun build(): ServiceOptions = ServiceOptions(
            deprecated,
            finishList(uninterpretedOption),
            unknownFields
        )
...
class MethodOptions private constructor(
    ...
    class MethodOptionsDsl {
        ...
        fun build(): MethodOptions = MethodOptions(
            deprecated,
            idempotencyLevel,
            finishList(uninterpretedOption),
            unknownFields
...
class UninterpretedOption private constructor(
    ...
    class UninterpretedOptionDsl {
        ...
        fun build(): UninterpretedOption = UninterpretedOption(
            finishList(name),
            identifierValue,
            positiveIntValue,
            negativeIntValue,
    ...
    companion object Deserializer :
        KtDeserializer<UninterpretedOption>,
...
class SourceCodeInfo private constructor(
    ...
    class SourceCodeInfoDsl {
        ...
        fun build(): SourceCodeInfo = SourceCodeInfo(
            finishList(location),
            unknownFields
        )
    }
    ...
    class Location private constructor(
        ...
        private fun messageSize(): Int {
            var result = 0
            if (path.isNotEmpty()) {
                result += sizeof(Tag(1)) + path.sumOf {
                    sizeof(com.toasttab.protokt.rt.Int32(it))
                }.let { it + sizeof(UInt32(it)) }
            }
            if (span.isNotEmpty()) {
                result += sizeof(Tag(2)) + span.sumOf {
                    sizeof(com.toasttab.protokt.rt.Int32(it))
                }.let { it + sizeof(UInt32(it)) }
            }
...
class GeneratedCodeInfo private constructor(
    ...
    class GeneratedCodeInfoDsl {
        ...
        fun build(): GeneratedCodeInfo = GeneratedCodeInfo(
            finishList(annotation),
            unknownFields
        )
    }

    companion object Deserializer :
        KtDeserializer<GeneratedCodeInfo>,
    ...
    class Annotation private constructor(
        ...
        class AnnotationDsl {
            ...
            fun build(): Annotation = Annotation(
                finishList(path),
                sourceFile,
                begin,
                end,
