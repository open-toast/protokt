...
| deserializeStringOneofStreaming | 19.024 | **18.704** | 18.753 | 19.265 | --- |
...
| passThroughStringOneof | 48.681 | **40.002** | 47.535 | 53.885 | 47.945 |
...
Oneof pass-through: Wire is fastest. All protokt codecs are close to their
mutate-and-serialize numbers. `KotlinxIoCodec` is slowest among them.
...
| mutateAndSerializeStringOneof | 49.496 | **39.236** | 47.868 | 54.082 | 48.302 |
| mutateAndSerializeStringOneof20k | 83.086 | **78.617** | 80.845 | 108 | 81.801 |
| mutateAndSerializeStringOneof20kStreaming | 84.697 | **78.562** | 86.808 | 93.080 | --- |
| mutateAndSerializeStringOneofStreaming | 42.232 | **39.944** | 43.628 | 46.721 | --- |
| mutateAndSerializeStringOneofVeryHeavy | 487 | 715 | **477** | 538 | 477 |
...
`KotlinxIoCodec` is consistently 5-30% slower than `ProtobufJavaCodec` on
oneof patterns.
...
| Byte arrays only | `ProtoktCodec` | Fastest serialization/deserialization. Zero external dependencies. |
| Minimal dependencies | `ProtoktCodec` | Ships with `protokt-runtime`, no additional dependencies needed. |
