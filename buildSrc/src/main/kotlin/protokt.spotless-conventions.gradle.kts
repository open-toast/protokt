...
allprojects {
    ...
    configure<SpotlessExtension> {
        ...
        kotlin {
            ...
            when (projectPath) {
                ":protokt-bootstrap" -> targetExclude("src/**/*.kt")

                ":protokt-core", ":protokt-core-lite" -> targetExclude("src/jvmMain/kotlin/com/toasttab/protokt/**/*.kt")

                ":extensions:protokt-extensions", ":extensions:protokt-extensions-lite" ->
        ...
        kotlinGradle {
            ...
            if (isRootProject) {
                target("settings.gradle.kts", "buildSrc/**/*.gradle.kts", "standalone-examples/**/*.gradle.kts")
            }
            targetExclude("**/build/**")
            licenseHeaderFile(
        ...
        format("kotlinLicense") {
            ...
            if (projectPath == ":protokt-bootstrap") {
