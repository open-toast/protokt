...
Supports proto3 and editions but _not_ proto2 features or their ported versions within editions.
...
- Multiplatform support for Kotlin JS and native (beta)
...
The runtime and generated code are compatible with Kotlin 2.2+, Java 17+, and Android 5.0+.

Within a stable major release, code generated by protokt 1.x is supported by runtime versions from
the same major that are at least as new as the generator. A runtime older than the generator is not
supported. Compatibility across major releases is not guaranteed. This source and binary policy is
separate from protobuf wire compatibility.
...
```kotlin
// Generated by protokt version 1.0.0-beta.12-SNAPSHOT. Do not modify.
...
public class Sample private constructor(
  private val _sampleField: LazyReference<Bytes, String>,
  public val unknownFields: UnknownFieldSet = UnknownFieldSet.empty()
) : AbstractMessage() {
  private val `$serializedSize`: Int by lazy {
    var result = 0
    if (_sampleField.wireValue().isNotEmpty()) {
      result += sizeOf(10u) + sizeOf(_sampleField.wireValue())
    }
  ...
  override fun serialize(writer: Writer) {
    if (_sampleField.wireValue().isNotEmpty()) {
      writer.writeTag(10u).write(_sampleField.wireValue())
    }
  ...
  override fun equals(other: Any?): Boolean =
    other is Sample &&
      other.sampleField == this.sampleField &&
  ...
  public class Builder : BuilderScope {
    private var _sampleFieldRef: LazyReference<Bytes, String>? = null

    public var sampleField: String
      get() = _sampleFieldRef?.value() ?: ""
      set(newValue) {
        _sampleFieldRef = LazyReference(newValue, StringConverter)
      }
    ...
    public fun build(): Sample =
      Sample(
        _sampleFieldRef ?: LazyReference(Bytes.empty(), StringConverter),
        unknownFields
      )

    public companion object Factory {
      @OnlyForUseByGeneratedProtoCode
      internal fun from(msg: Sample): Builder =
        Builder().also {
          it._sampleFieldRef = msg._sampleField
  ...
  public companion object Deserializer : AbstractDeserializer<Sample>() {
    ...
    override fun deserialize(reader: Reader): Sample {
      ...
      while (true) {
        when (reader.readTag()) {
          0u -> {
            return Sample(
              LazyReference(sampleField ?: Bytes.empty(), StringConverter),
              UnknownFieldSet.from(unknownFields)
            )
          }

          10u -> {
            sampleField = StringConverter.readValidatedBytes(reader)
          }
    ...
    @JvmStatic
    public operator fun invoke(dsl: Builder.() -> Unit): Sample =
      Builder().apply(dsl).build()
  }
}

@GeneratedFileDescriptor
public object sample_file_descriptor {
  public val descriptor: FileDescriptor by lazy {
    val descriptorData =
      arrayOf(
        "<encoded file descriptor bytes>"
      )
...
public val Sample.Deserializer.descriptor: Descriptor
  get() = sample_file_descriptor.descriptor.messageTypes[0]
...
Integration tests run on Linux, macOS, and Windows across Kotlin 2.2-2.4 and
JDK 17, 21, and 25.
